...
<div style="text-align:center">![formula](https://render.githubusercontent.com/render/math?math=TF=\frac{Nt}{Tt})


Where **Nt = Number of instances of *t* in document**, **Tt = Total number of terms in document**


<div style="text-align:center">![formula](https://render.githubusercontent.com/render/math?math=IDF=log(\frac{Td}{Dt})
